...
$trans["biblioCopyNewDescError"]   = "\$text = 'Beschreibung wird benötigt';";

#****************************************************************************
#*  Translation text for page biblio_copy_edit.php
#****************************************************************************
$trans["biblioCopyEditSuccess"]    = "\$text = 'Exemplar erfolgreich aktualisiert.';";
$trans["biblioCopyEditDescError"]  = "\$text = 'Beschreibung wird benötigt';";
...
$trans["biblioMarcListDel"]        = "\$text = 'Löschen';";
...
$trans["biblioHoldListdel"]        = "\$text = 'Löschen';";
