...
<table class="primary">
  <tr>
    ...
    <th align="left" nowrap="yes">
	 ...
	 <th align="left" nowrap="yes">
      <?php echo $loc->getText("biblioViewTble2Col6");// Bemerkung als Exemplar Feld hinzugefügt ?>
    </th>
	 <th align="left" nowrap="yes">
      <?php echo $loc->getText("biblioViewTble2Col7");// Gerätedaten als Exemplar Feld hinzugefügt ?>
    </th>
	 <th align="left" nowrap="yes">
      <?php echo $loc->getText("biblioViewTble2Col8");// Inhalt als Exemplar Feld hinzugefügt?>
    </th>
	<th align="left" nowrap="yes">
      <?php echo $loc->getText("biblioViewTble2Col9");// Inventarnummer als Exemplar Feld hinzugefügt?>
    </th>
	<th align="left" nowrap="yes">
      <?php echo $loc->getText("biblioViewTble2Co20");// Mängel als Exemplar Feld hinzugefügt?>
    </th>
	
	<th align="left" nowrap="yes">
      <?php echo $loc->getText("biblioViewTble2Co21");// Seriennummer als Exemplar Feld hinzugefügt ?>
    </th>
  ...
  ?>
    <tr>
	  ...
	  /**
	  Programmierer: Roman Sheetz
	   Eine eigene Exemplarausgabe programmiert 
	 */
	  foreach ($copy->_custom as $name => $title) {
    if ($value = $copy->_custom[$name]) {
	?>
		<td valign="top" class="<?php echo H($row_class);?>">
		  <?php echo H($value);?>
		</td>
