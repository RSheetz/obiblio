...
." b.bibid,null,  null,     b.barcode_nmbr,ifnull(bs.status_cd,'in'),ifnull(bs.status_begin_dt,b.create_dt),bs.due_back_dt,bs.mbrid from "
  ...
  function _upgrade040_e($prfx, $tmpPrfx) {
    ...
    $this->exec('alter table '.$prfx.'staff modify pwd char(64)'); //	char(32)					Autor: Roman Sheetz geändert am 10.06.2022
    $this->exec('update '.$prfx.'staff set pwd=sha2(%Q,256)');	//  md5(lower(username))	Autor: Roman Sheetz geändert am 10.06.2022
