...
<table class="primary">
  <tr>
	...
	<?php
	/**
	Autor entfernt aus der Darstellung
...
#*  Implemtierung eines Buttons für das Absenden einer Bestätigungsmail für die Ausleihe 

#**********************************************************************************************/
?>
<form action="../Mails/Mails_Bestaetigung.php" method="POST">
 <input type="hidden" name="mbrid" value="<?php echo H($mbrid);?>";>
 <input type="submit" value="Ausleihbestätigung?"; class="button">
</form> 
...
?>
  <tr>
	...
	*/
    ...
    <td class="primary" valign="top" >
      <a href="../circ/checkout.php?barcodeNmbr=<?php echo HURL($biblio->getBarcodeNmbr());?>&amp;mbrid=<?php echo HURL($mbrid);?>&amp;renewal"><?php echo $loc->getText("Renew item"); ?></A>
      <?php
...
<table class="primary">
  <tr>
	...
	<?php
	/**
	Edit: 13.05.2020 Autor entfernt aus der Darstellung
