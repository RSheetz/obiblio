...
<table class="primary">
  ...
  <?php
	...
	{
	/**
	Hiermit wird das entfernen des Administrators und somit eine Unbrauchbarkeit des Programms verhindert
	Hinzugefügt vom Autor: Roman Sheetz
	
	Dadurch dass der Button fürs löschen beim Administrator nicht dargestellt wird.
	*/
  ?>
  <tr>
    ...
    <td valign="top" class="<?php echo H($row_class);?>">	
	 <a href="../admin/staff_del_confirm.php?UID=<?php echo HURL($staff->getUserid());?>&amp;LAST=<?php echo HURL($staff->getLastName());?>&amp;FIRST=<?php echo HURL($staff->getFirstName());?>" class="<?php echo H($row_class);?>">
	 <?php  if($staff->getLastName()!="Administrator"){ echo $loc->getText("adminStaff_list_Del");} ?></a>
    </td>
    <td valign="top" class="<?php echo H($row_class);?>">
