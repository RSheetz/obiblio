  ...
  <tr>
    <td nowrap="true" class="primary">
      <select name="searchType">
        <option value="keyword" selected><?php echo $loc->getText("opac_Keyword");?>
       <?php //<option value="author"><?php echo $loc->getText("opac_Author"); geändert am 26.07.2022 Autor: Roman Sheetz?>
        <option value="title"><?php echo $loc->getText("opac_Title");?>
        <?php // <option value="subject"><?php echo $loc->getText("opac_Subject"); geändert am 26.07.2022 Autor: Roman Sheetz?>
        <option value="callno"><?php echo $loc->getText("opac_Callno");?>
      </select>
