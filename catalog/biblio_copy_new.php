 ...
 */
  ...
  *	Datum:06.05.2020  
  *
  *	Versuch einer eigenen Notwenigkeitsfunktion um Pflichtfelder zu generieren.
  * 
  /***************************************************************************/
  ...
  // Ergänzung als Pflichtfelder für die Beschreibung. Autor: Roman Sheetz
  
  if ((!$validData)or(empty($_POST["copyDesc"]))) {
	  
	 if(empty($_POST["copyDesc"]))
	 {
		 $pageErrors["copyDesc"] = $loc->getText("biblioCopyNewDescError");
	 }
